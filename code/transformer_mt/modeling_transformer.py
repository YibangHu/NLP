...
class TransfomerEncoderDecoderModel(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.encoder_layers = nn.ModuleList(TransformerEncoderLayer(hidden=hidden, num_heads=num_heads, fcn_hidden=fcn_hidden, dropout=dropout)
    ...
    def _encode(self, input_ids, key_padding_mask):
        ...
        x = self.encoder_embeddings(input_ids)
        encoder_hidden_states = self._add_positions(x)
